class Preload extends Phaser.Scene {
	...
	preload() {
        // brown tank
        this.load.image('tank-body-brown', 'images/Hulls_Color_A/Hull_01.png')
        this.load.image('tank-turret-brown', 'images/Weapon_Color_A/Gun_01.png')
        // green tank
        this.load.image('tank-body-green', 'images/Hulls_Color_B/Hull_01.png')
        this.load.image('tank-turret-green', 'images/Weapon_Color_B/Gun_01.png')
        // cyan tank
        this.load.image('tank-body-cyan', 'images/Hulls_Color_C/Hull_01.png')
        this.load.image('tank-turret-cyan', 'images/Weapon_Color_C/Gun_01.png')
        // blue tank
        this.load.image('tank-body-blue', 'images/Hulls_Color_D/Hull_01.png')
        this.load.image('tank-turret-blue', 'images/Weapon_Color_D/Gun_01.png')
        // others
        this.load.image('heavy-shell', 'images/Effects/Heavy_Shell.png')
        this.load.image('granade-shell', 'images/Effects/Granade_Shell.png')
...
const config = {
    ...
    scene: [ Boot, Preload, GameTitle, Main, GameOver ],
};
